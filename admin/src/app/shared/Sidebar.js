...
class Sidebar extends Component {
  ...
  onRouteChanged() {
    ...
    const dropdownPaths = [
      ...
      { path: '/student-pages', state: 'studentPagesMenuOpen' } // ✅ new
    ...
    return (
      <nav className="sidebar sidebar-offcanvas" id="sidebar">
        <ul className="nav">
          ...
          <li className={this.isPathActive('/student-pages') ? 'nav-item active' : 'nav-item'}>
            <div
              className={this.state.studentPagesMenuOpen ? 'nav-link menu-expanded' : 'nav-link'}
              onClick={() => this.toggleMenuState('studentPagesMenuOpen')}
            ...
            <Collapse in={this.state.studentPagesMenuOpen}>
              <ul className="nav flex-column sub-menu">
                <li className="nav-item">
                  <Link
                    className={
                      this.isPathActive('/student-pages/student-list')
                        ? 'nav-link active'
                        : 'nav-link'
                    }
                    to="/student-pages/student-list"
                  >
                    Student List
                  </Link>
                </li>
          ...
          <li className={ this.isPathActive('/general-pages') ? 'nav-item active' : 'nav-item' }>
            <div className={ this.state.generalPagesMenuOpen ? 'nav-link menu-expanded' : 'nav-link' } onClick={ () => this.toggleMenuState('generalPagesMenuOpen') } data-toggle="collapse">
              <span className="menu-title"><Trans>Professor</Trans></span>
              <i className="menu-arrow"></i>
            ...
            <Collapse in={ this.state.generalPagesMenuOpen }>
              <ul className="nav flex-column sub-menu">
                ...
                <li className="nav-item"> <Link className={ this.isPathActive('/general-pages/appoint-professor') ? 'nav-link active' : 'nav-link' } to="/general-pages/appoint-professor">Appoint Professor</Link></li>
                <li className="nav-item"> <Link className={ this.isPathActive('/general-pages/professors') ? 'nav-link active' : 'nav-link' } to="/general-pages/professors">Professors List</Link></li>
              </ul>
            </Collapse>
          </li>{/*
          <li className="nav-item">
